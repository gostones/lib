// Package lib is based on https://github.com/cenkalti/backoff/blob/master/exponential.go
package lib
...
// BackOff is exponential backoff
type BackOff struct {
	attempts int
	interval time.Duration
}

// NewBackOff contructs a backoff with provided attempts and duration
func NewBackOff(attempts int, d time.Duration) BackOff {
	return BackOff{attempts: attempts, interval: d}
}

// NewDefaultBackOff constructs a backoff with default values
